$(function(){
    ...
    // Пример тестирования функционала объекта
    ...
    }).toConsole().clearStack();


    // Существует возможность работать с группами разными способами
    yats
        // #1
        .group('ok/not')
